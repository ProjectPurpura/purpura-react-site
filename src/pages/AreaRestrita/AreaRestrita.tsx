    ...
    <div className="area-restrita-container">
      <header className="area-restrita-header">
        ...
        {!user ? (
          ...
          <iframe title="Bi_Inter" src="https://app.powerbi.com/view?r=eyJrIjoiMDA5NjFlZGMtYzZjZS00NzY4LWJlM2MtNDRmZmJlNzA1YjA5IiwidCI6ImIxNDhmMTRjLTIzOTctNDAyYy1hYjZhLTFiNDcxMTE3N2FjMCJ9" allowFullScreen={true}></iframe>
        )}
    </div>
  );
};
